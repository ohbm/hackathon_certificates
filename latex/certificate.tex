...
\emph{\bfseries \{Year\} Organization of Human Brain Mapping Hackathon} 
organized by the 
...
\vfill
 \begin{minipage}[l]{2.8in}
	\sigskip 
	\includegraphics[width=.85\linewidth]{../data/signature/signature.pdf}
  	\signature{}{\{Name\}\\ Open Science SIG Hackathon Chair }
 \end{minipage}
 \hfill
